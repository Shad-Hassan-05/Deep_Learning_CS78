...
# wrapper class to allow the usage of transforms on dataset
...
def cnn_categorization(model_type="base",
    ...
    if model_type == "base":
        ...
        # create netspec_opts as outlined in HW pdf
        netspec_opts = {
        ...
        # create train_opts as outlined in HW pdf
        ...
        train_ds = AugmentedTensorDataset(*train_ds.tensors, transform=aug)

        # create netspec_opts
        netspec_opts = {
            'kernel_size' : [3,0,0,   3,0,0,   3,0,0,   3,0,0,     5,0,0,      8,1],
            'num_filters' : [16,16,0, 64,64,0, 128,128,0, 128,128,0, 256,256,0,  0,16],
            'stride' :      [1,0,0,   1,0,0,   1,0,0,   2,0,0,     2,0,0,      1,1],
            'layer_type' :  ['conv','bn','relu', 'conv','bn','relu', 'conv','bn','relu',
                             'conv','bn','relu', 'conv','bn','relu', 'pool','conv']
        }
...
if __name__ == '__main__':
    ...
    # For example, to change the model type from base to improved
